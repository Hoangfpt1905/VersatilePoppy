...
public class InapppucharseActivity extends AppCompatActivity implements PurchasesUpdatedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bPucharse.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if (getPurchaseValueFromPref()) {
            bPucharse.setVisibility(View.GONE);
            tvStatus.setText("Purchase Status : Purchased");
        }
        //item not Purchased
        else {
            bPucharse.setVisibility(View.VISIBLE);
                        ...
                        if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                            if (skuDetailsList != null && skuDetailsList.size() > 0) {
                                BillingFlowParams flowParams = BillingFlowParams.newBuilder()
                                        ...
                                        .build();
                                billingClient.launchBillingFlow(InapppucharseActivity.this, flowParams);
                            } else {
    ...
    AcknowledgePurchaseResponseListener ackPurchase = new AcknowledgePurchaseResponseListener() {
        ...
        public void onAcknowledgePurchaseResponse(BillingResult billingResult) {
            if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                ...
                savePurchaseValueToPref(true);
                Toast.makeText(getApplicationContext(), "Item Purchased", Toast.LENGTH_SHORT).show();
                InapppucharseActivity.this.recreate();
            }
        }
    };
